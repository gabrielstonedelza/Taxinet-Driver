                      ...
                      RawMaterialButton(
                        onPressed: () {
                          if(_priceController.text == "" || _currentSelectedPaymentMethod == "Select payment method"){
                            ...
                            controller.driverEndTrip(controller.passengerId,title,_priceController.text.trim(),_currentSelectedPaymentMethod);
                  ...
                  child: CircularProgressIndicator.adaptive(
                    ...
                    backgroundColor: primaryColor,
                        ...
                        Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              const Text("Initial Payment",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15)),
                              const SizedBox(height:10),
                              GetBuilder<ScheduleController>(builder: (controller) {
